    ...
    <>
      <div className="bg-bgGray">
        ...
        <div className="_container  mt-4 flex-col items-center">
          <div className="w-full bg-[#fdfcf5] px-4 pt-2 box-shadow">
            <div className="text-center flex justify-between mb-4 lg:text-start md:flex md:justify-between">
              ...
              <button className="border border-blue-400 transition duration-500 hover:bg-blue-400 hover:text-white rounded-sm md:py-1 md:px-1 md:flex md:justify-center md:items-center">
                View All
              </button>
            </div>
              ...
              {main.map((item, index) => (
                ...
                >
                  ...
                  <div className="button w-full h-full absolute text-center invisible flex flex-col group-hover:visible items-center justify-center">
                    <button className="translate-y-[-30px] font-bold text text-white rounded-md bg-[#f90] m-auto py-3 px-4 flex items-center justify-center ">
                      Add To Card
                    </button>
                  ...
                  <div className="text text-center">
                    <p className="w-[70%] m-auto">
                      A compleat Biography of Abraham
                    </p>
          ...
          <div className="w-full px-4 pt-2 box-shadow">
            ...
            <div className="grid grid-cols-2 gap-3 gap-y-3 sm:grid-3 sm:gap-3 md:grid-cols-3 lg:gap-2 lg:grid-cols-6 p-4 md:p-5 items-center ">
              {cards.map((item, index) => (
                <div
                  key={index}
                  className="card w-[165px] m-auto  h-[170px] bg-gray-200 text-center flex flex-col items-center justify-center"
                >
                  <img
        ...
        <div className="_container mb-4 bg-white h-auto mt-3 flex flex-col items-center">
          <div className="w-full px-4 pt-2 box-shadow">
            <div className="text-center mb-4 lg:text-start">
              <h1 className="text-xl md:text-2xl lg:text-3xl lg:font-thin">
                Superstore
              </h1>
            </div>
            <div className="grid grid-cols-2 gap-3 md:p-5  md:grid-cols-3 lg:gap-2 lg:grid-cols-6  p-4 items-center">
              {cards.map((item, index) => (
                <div
                  key={index}
                  className=" m-auto card w-[165px] h-[179px] bg-gray-200 text-center flex flex-col items-center "
                >
                  <img
                    className="object-cover w-full h-full"
                    src={item.imageUrl}
                  ...
                  />
                  <div className="text mt-2">
                    <h1 className="text-[20px] text-sm md:text-base">
                      {item.title}
                    </h1>
                  </div>
                </div>
          ...
          <div className="w-full bg-white px-4 pt-2 box-shadow">
            ...
            <div className="grid grid-cols-2 gap-3 gap-y-4 sm:grid-3 sm:gap-3 md:grid-cols-3 lg:gap-2 lg:grid-cols-6 p-4 md:p-5 items-stretch ">
              {cards4.map((item, index) => (
                <div
                  key={index}
                  className="card w-[165px] m-auto  h-[170px] text-center flex flex-col items-center justify-center"
                >
                  <img
                    className="object-cover w-[136px] h-[132px]"
                    src={item.imageUrl}
                    alt={`Card ${index + 1}`}
                  />
                  <a
                    href="#"
                    className="mt-3 flex items-center text-blue-500 font-light"
                  >
                    {item.links} <RiArrowRightWideLine />
                  </a>
                </div>
              ))}
            </div>
