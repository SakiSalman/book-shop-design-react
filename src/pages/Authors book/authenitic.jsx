...
const authenitic = () => {
  return (
    <div className="parren hidden md:block md:bg-bgGray h-auto py-2">
      <div className="_container">
        <div className="identify-cards flex flex-col">
          ...
          <div className="card-3 w-[294px] h-[377px] bg-white mt-4">
            <div className="flex p-3">
              ...
              <a href="#">Reser Filter</a>
            </div>
            <hr />
            <div className="search-sec p-3 ">
              <h2>Shop by catagoris</h2>
            ...
            <div className="chekbox-other p-3 h-64 overflow-y-auto border ">
              <div className="chek">
                ...
                <label htmlFor="#">সমকালিন উপন্নাস</label>
              </div>
            ...
            <div className="search p-4">
              ...
              <div className="search-in">
                ...
                <div className="search-body mt-2">
                    <div className="main ">
                    <input type="checkbox" /><label htmlFor="#">Home</label><br />
                    <input type="checkbox" /><label htmlFor="#">Home</label><br />
          ...
          <div className="card4 mt-4 w-[294px] h-auto bg-white">
            <div className="card-title p-4 h-[177px]">
              <h1 className="text-xl font-semibold">Price</h1>
              <div className="range relative pt-4">
                <div className="flex justify-between items-center mb-2">
                ...
                <div className="search-body mt-2 ">
                    <div className="start ">
                       <div className="st flex ">
                        <input type="checkbox" />
                        <label htmlFor="#" className="flex gap-2 text-2xl text-yellow-400"><MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /></label>
                       </div>
                       <div className="st flex">
                        <input type="checkbox" />
                        <label htmlFor="#" className="flex gap-2 text-2xl text-yellow-300"><MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /></label>
                       </div>
                       <div className="st flex">
                        <input type="checkbox" />
                        <label htmlFor="#" className="flex gap2 text-2xl text-yellow-300"><MdOutlineStar /> <MdOutlineStar /> <MdOutlineStar /></label>
                       </div>
                       <div className="st flex">
                        <input type="checkbox" />
                        <label htmlFor="#" className="flex text-yellow-300 text-2xl"><MdOutlineStar /> <MdOutlineStar /></label>
                       </div>
